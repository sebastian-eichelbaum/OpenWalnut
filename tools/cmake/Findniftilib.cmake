...
IF( NIFTILIB_INCLUDE_DIR AND NIFTILIB_LIBRARY AND NIFTIZNZ_LIBRARY )
    SET( NIFTILIB_FOUND TRUE )
ENDIF()

IF( NIFTILIB_FOUND )
   IF( NOT niftilib_FIND_QUIETLY )
       MESSAGE( STATUS "Found niftilib: ${NIFTILIB_LIBRARY}, ${NIFTIZNZ_LIBRARY} and include in ${NIFTILIB_INCLUDE_DIR}" )
   ENDIF()
ELSE()
