 ...
 */
typedef boost::array< std::pair< double, WVector3d_2 >, 3 > RealEigenSystem;

/**
 * An eigensystem has all eigenvalues as well its corresponding eigenvectors.
 */
typedef boost::array< std::pair< std::complex< double >, WVector3d_2 >, 3 > EigenSystem;
 ...
 */
template< typename Data_T >
double evaluateSphericalFunction( WTensorSym< 4, 3, Data_T > const& tens, WVector3d_2 const& gradient )
{
 ...
 */
template< typename Data_T >
double evaluateSphericalFunction( WTensorSym< 2, 3, Data_T > const& tens, WVector3d_2 const& gradient )
{
