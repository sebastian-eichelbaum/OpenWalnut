...
public:
    ...
    void testForwardingFunctions( void )
    {
        ...
        WBoundingBox bb1( bb );
        WBoundingBox bb2;
        WBoundingBox bb3( WVector3d_2( 0.0, 0.0, 0.0 ), WVector3d_2( 1.0, 1.0, 1.0 ) );
    ...
    void testBoundingBoxComputation( void )
    {
        WBoundingBox box;
        TS_ASSERT( !box.valid() );
        box.expandBy( WPosition_2( 0.0, 0.0, 0.0 ) );
        TS_ASSERT( box.valid() );
        ...
        box.expandBy( WPosition_2(  1.0, 0.0, 0.0 ) );
        box.expandBy( WPosition_2( -1.0, 0.0, 0.0 ) );
        box.expandBy( WPosition_2( -1.0, 3.0, 0.0 ) );
