...
namespace wge
{
     ...
     */
    osg::ref_ptr< osg::Vec3Array > WGE_EXPORT generateCuboidQuads( const std::vector< WPosition_2 >& corners );
     ...
     */
    osg::Vec3 WGE_EXPORT getQuadNormal( const WPosition_2& a, const WPosition_2& b, const WPosition_2& c );
     ...
     */
    osg::ref_ptr< osg::Vec3Array > WGE_EXPORT generateCuboidQuadNormals( const std::vector< WPosition_2 >& corners );
     ...
     */
    WTriangleMesh WGE_EXPORT triangulate( const std::vector< WPosition_2 >& points, double transformationFactor = 0.0 );
}
