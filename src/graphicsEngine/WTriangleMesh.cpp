...
void WTriangleMesh::addVertex( WPosition_2 vert )
{
...
void WTriangleMesh::setVertexNormal( size_t index, WPosition_2 normal )
{
    WAssert( index < m_countVerts, "set vertex normal: index out of range" );
...
WPosition_2 WTriangleMesh::getVertexAsPosition( size_t index ) const
{
    WAssert( index < m_countVerts, "get vertex as position: index out of range" );
    return WPosition_2( ( *m_verts )[index][0], ( *m_verts )[index][1], ( *m_verts )[index][2] );
}

WPosition_2 WTriangleMesh::getVertexAsPosition( size_t triangleIndex, size_t vertNum )
{
    ...
    return WPosition_2( v[0], v[1], v[2] );
}
