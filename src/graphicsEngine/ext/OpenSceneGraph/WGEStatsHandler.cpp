...
#include "WGEStatsHandler.h"

using namespace osgViewer;

WGEStatsHandler::WGEStatsHandler():
...
bool WGEStatsHandler::handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa)
{
...
void WGEStatsHandler::updateThreadingModelText()
{
...
void WGEStatsHandler::setUpHUDCamera(osgViewer::ViewerBase* viewer)
{
...
{
    BlockDrawCallback(WGEStatsHandler* statsHandler, float xPos, osg::Stats* viewerStats, osg::Stats* stats, const std::string& beginName, const std::string& endName, int frameDelta, int numFrames):
...
osg::Geometry* WGEStatsHandler::createBackgroundRectangle(const osg::Vec3& pos, const float width, const float height, osg::Vec4& color)
{
...
osg::Geometry* WGEStatsHandler::createGeometry(const osg::Vec3& pos, float height, const osg::Vec4& colour, unsigned int numBlocks)
{
    osg::Geometry* geometry = new osg::Geometry;
...
{
    FrameMarkerDrawCallback(WGEStatsHandler* statsHandler, float xPos, osg::Stats* viewerStats, int frameDelta, int numFrames):
        _statsHandler(statsHandler),
        _xPos(xPos),
        _viewerStats(viewerStats),
        _frameDelta(frameDelta),
...
osg::Geometry* WGEStatsHandler::createFrameMarkers(const osg::Vec3& pos, float height, const osg::Vec4& colour, unsigned int numBlocks)
{
    osg::Geometry* geometry = new osg::Geometry;
...
osg::Geometry* WGEStatsHandler::createTick(const osg::Vec3& pos, float height, const osg::Vec4& colour, unsigned int numTicks)
{
    osg::Geometry* geometry = new osg::Geometry;
...
void WGEStatsHandler::setUpScene(osgViewer::ViewerBase* viewer)
{
    ...
    std::string font( WGEResourceManager::getResourceManager()->getDefaultFont() );
...
osg::Node* WGEStatsHandler::createCameraTimeStats(const std::string& font, osg::Vec3& pos, float startBlocks, bool acquireGPUStats, float characterSize, osg::Stats* viewerStats, osg::Camera* camera)
{
...
void WGEStatsHandler::getUsage(osg::ApplicationUsage& usage) const
{
