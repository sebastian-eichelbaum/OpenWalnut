...
//    {
//        WTriangleMesh mesh;
//        std::vector< WPosition_2 > vertices( 4 );
//
//        TS_ASSERT_EQUALS( mesh.m_fastAddVertId, 0 );
//        TS_ASSERT_EQUALS( mesh.m_vertices.size(), 0 );
...
//        WPosition_2 newVert0( 0, 0, 0 );
//        mesh.fastAddVert( newVert0 );
//
//        WPosition_2 newVert1( 1.3, 2.25, 3.435 );
//        mesh.fastAddVert( newVert1 );
//
//        WPosition_2 newVert2( 1, 2, 3 );
//        mesh.fastAddVert( newVert2 );
//
//        WPosition_2 newVert3( 1.2, 1.5, 1.7 );
//        mesh.fastAddVert( newVert3 );
//
//        WPosition_2 newVert4( 1, 1, 1 );
...
//
//        // what we expect
//        WVector3d_2 expectedNormal0( -0.40824829, 0.816496581, -0.40824829 );
//        WVector3d_2 expectedNormal1( -0.452271958, 0.814852852, -0.362580895 );
//        double delta = 1e-7;
//
...
//        WVector3d_2 expectedVertNormal = 0.5 * ( expectedNormal0 + expectedNormal1 );
...
//    }
    ...
    void testEqualityOperator( void )
    {
        ...
        mesh.addVertex( WPosition_2( 1,  0, 0 ) );
        mesh.addVertex( WPosition_2( 0,  1, 0 ) );
        mesh.addVertex( WPosition_2( 1,  0, 0 ) );
    ...
    void testComponentDecomposition( void )
    {
        ...
        mesh.addVertex( WPosition_2( 1,  0, 0 ) ); // 0
        mesh.addVertex( WPosition_2( 0,  1, 0 ) ); // 1
        mesh.addVertex( WPosition_2( 2,  1, 0 ) ); // 2
        mesh.addVertex( WPosition_2( 0,  2, 0 ) ); // 3
        mesh.addVertex( WPosition_2( 2,  2, 0 ) ); // 4
        mesh.addVertex( WPosition_2( 0,  3, 0 ) ); // 5
        mesh.addVertex( WPosition_2( 3,  4, 0 ) ); // 6
        mesh.addVertex( WPosition_2( 3,  5, 0 ) ); // 7
        mesh.addVertex( WPosition_2( 5,  5, 0 ) ); // 8
        mesh.addVertex( WPosition_2( 0,  6, 0 ) ); // 9
        mesh.addVertex( WPosition_2( 2,  6, 0 ) ); // 10
        mesh.addVertex( WPosition_2( 4,  6, 0 ) ); // 11
        mesh.addVertex( WPosition_2( 1,  7, 0 ) ); // 12
        mesh.addVertex( WPosition_2( 3,  8, 0 ) ); // 13
        mesh.addVertex( WPosition_2( 1,  9, 0 ) ); // 14
        mesh.addVertex( WPosition_2( 3,  9, 0 ) ); // 15
        mesh.addVertex( WPosition_2( 6, 10, 0 ) ); // 16
        mesh.addVertex( WPosition_2( 7, 10, 0 ) ); // 17
        mesh.addVertex( WPosition_2( 0, 11, 0 ) ); // 18
        mesh.addVertex( WPosition_2( 2, 11, 0 ) ); // 19
        mesh.addVertex( WPosition_2( 4, 11, 0 ) ); // 20
        mesh.addVertex( WPosition_2( 1, 12, 0 ) ); // 21
        mesh.addVertex( WPosition_2( 3, 12, 0 ) ); // 23
        mesh.addVertex( WPosition_2( 6, 12, 0 ) ); // 23
        mesh.addVertex( WPosition_2( 7, 12, 0 ) ); // 24
        ...
        expected.addVertex( WPosition_2( 1, 0, 0 ) );
        expected.addVertex( WPosition_2( 0, 1, 0 ) );
        expected.addVertex( WPosition_2( 2, 1, 0 ) );
        expected.addTriangle( 0, 1, 2 );
        TS_ASSERT_EQUALS( **cit, expected );

//        expected.resizeVertices( 2 );
//        expected.m_vertices[ 0 ] = WPosition_2( 0, 2, 0 );
//        expected.m_vertices[ 1 ] = WPosition_2( 2, 2, 0 );
...
//        expected.m_vertices[ 0 ] = WPosition_2( 0, 3, 0 );
//        expected.resizeTriangles( 1 );
...
//        expected.m_vertices[ 0 ] = WPosition_2( 0,  6, 0 );
//        expected.m_vertices[ 1 ] = WPosition_2( 2,  6, 0 );
//        expected.m_vertices[ 2 ] = WPosition_2( 1,  7, 0 );
//        expected.m_vertices[ 3 ] = WPosition_2( 3,  4, 0 );
//        expected.m_vertices[ 4 ] = WPosition_2( 4,  6, 0 );
