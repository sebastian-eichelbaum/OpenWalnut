...
WCustomView::SPtr WScriptUI::openCustomWidget( std::string, WGECamera::ProjectionMode, boost::shared_ptr< WCondition > )
{
    return WCustomView::SPtr();
}
...
void WScriptUI::closeCustomWidget( WCustomView::SPtr )
{
}
