...
#ifndef WMESHREADERFREESURFER_H
#define WMESHREADERFREESURFER_H
 ...
 */
class WMeshReaderFreesurfer: public WObjectNDIP< WMeshReaderInterface >
{
public:
    /**
     * Constructor
