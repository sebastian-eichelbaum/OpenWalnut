...
#ifndef WMESHREADERFIBERNAVIGATOR_H
#define WMESHREADERFIBERNAVIGATOR_H
 ...
 */
class WMeshReaderFiberNavigator: public WObjectNDIP< WMeshReaderInterface >
{
public:
    /**
     * Constructor
...
#endif  // WMESHREADERFIBERNAVIGATOR_H
