...
private:
    ...
    WPosition_2 m_p0; //!< stores the last position of the center manipulator
    WPosition_2 m_p1; //!< stores the last position of  manipulator 1
    WPosition_2 m_p2; //!< stores the last position of  manipulator 2
    WPosition_2 m_p3; //!< stores the last position of  manipulator 3
    WPosition_2 m_p4; //!< stores the last position of  manipulator 4
