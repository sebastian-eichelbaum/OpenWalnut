...
void WMOverlayAtlas::init()
{
    ...
    m_p1 = WPosition_2( center[0], center[1], center[2] );
    m_p2 = WPosition_2( center[0], center[1], center[2] );
    m_p3 = WPosition_2( center[0], center[1], center[2] );
    m_p4 = WPosition_2( center[0], center[1], center[2] );
...
void WMOverlayAtlas::manipulatorMoved()
{
    ...
    m_s0->setPosition( WPosition_2( m_s0->getPosition()[0], m_coronalSlices[i].position(), m_s0->getPosition()[2] ) );

    WPosition_2 s0Move = m_s0->getPosition() - m_p0;
...
void WMOverlayAtlas::updatePlane()
{
    ...
    WPosition_2 v0( m_p1[0], m_p1[1], m_p2[2] );
    WPosition_2 v1( m_p3[0], m_p3[1], m_p2[2] );
    WPosition_2 v2( m_p3[0], m_p3[1], m_p4[2] );
    WPosition_2 v3( m_p1[0], m_p1[1], m_p4[2] );
