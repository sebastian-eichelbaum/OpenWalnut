...
osg::ref_ptr< osg::Geometry > WRulerOrtho::createXY()
{
    ...
    switch ( m_coordConverter->getCoordinateSystemMode() )
    {
        ...
        case CS_TALAIRACH:
        {
            WVector3d_2 origin_t = m_coordConverter->w2t( WVector3d_2( m_origin[0], m_origin[1], m_origin[2] ) );

            WVector3d_2 pA = m_coordConverter->t2w( WVector3d_2( origin_t[0], -70, origin_t[2] ) );
            WVector3d_2 pO = m_coordConverter->t2w( WVector3d_2( origin_t[0], +70, origin_t[2] ) );
            ...
            for ( int i = -70; i <= 71; ++i )
            {
                WVector3d_2 tmpPoint = m_coordConverter->t2w( WVector3d_2( origin_t[0], i, origin_t[2] ) );
                float rlength = 1.0;
                if ( i % 10 == 0 )
                {
                    rlength += 1.0;
                ...
                WVector3d_2 p1 = m_coordConverter->t2w( WVector3d_2( origin_t[0] - rlength, i, origin_t[2] ) );
                WVector3d_2 p2 = m_coordConverter->t2w( WVector3d_2( origin_t[0] + rlength, i, origin_t[2] ) );
    ...
    switch ( m_coordConverter->getCoordinateSystemMode() )
    {
        ...
        case CS_TALAIRACH:
        {
            ...
            for ( int i = -70; i <= 71; ++i )
            {
                ...
                WVector3d_2 p1 = m_coordConverter->t2w( WVector3d_2( origin_t[0], i, origin_t[2] - rlength ) );
                WVector3d_2 p2 = m_coordConverter->t2w( WVector3d_2( origin_t[0], i, origin_t[2] + rlength ) );
...
osg::ref_ptr< osg::Geometry > WRulerOrtho::createYX()
{
    ...
    switch ( m_coordConverter->getCoordinateSystemMode() )
    {
        ...
        case CS_TALAIRACH:
        {
            ...
            WVector3d_2 pA = m_coordConverter->t2w( WVector3d_2( -100, origin_t[1], origin_t[2] ) );
            WVector3d_2 pO = m_coordConverter->t2w( WVector3d_2( 80, origin_t[1], origin_t[2] ) );
            ...
            {
                WVector3d_2 tmpPoint = m_coordConverter->t2w( WVector3d_2( i, origin_t[1], origin_t[2] ) );
                float rlength = 1.0;
                if ( i % 10 == 0 )
                {
                    rlength += 1.0;
                ...
                WVector3d_2 p1 = m_coordConverter->t2w( WVector3d_2( i, origin_t[1] - rlength, origin_t[2] ) );
                WVector3d_2 p2 = m_coordConverter->t2w( WVector3d_2( i, origin_t[1] + rlength, origin_t[2] ) );
...
osg::ref_ptr< osg::Geometry > WRulerOrtho::createYZ()
{
    ...
    switch ( m_coordConverter->getCoordinateSystemMode() )
    {
        ...
        case CS_TALAIRACH:
        {
            ...
            for ( int i = -100; i <= 81; ++i )
            {
                WVector3d_2 tmpPoint = m_coordConverter->t2w( WVector3d_2( i, 0, origin_t[2] ) );
                float rlength = 1.0;
                if ( i % 10 == 0 )
                {
                    rlength += 1.0;
                ...
                WVector3d_2 p1 = m_coordConverter->t2w( WVector3d_2( i, origin_t[1], origin_t[2] - rlength ) );
                WVector3d_2 p2 = m_coordConverter->t2w( WVector3d_2( i, origin_t[1], origin_t[2] + rlength ) );
...
osg::ref_ptr< osg::Geometry > WRulerOrtho::createZX()
{
    ...
    switch ( m_coordConverter->getCoordinateSystemMode() )
    {
        ...
        case CS_TALAIRACH:
        {
            ...
            WVector3d_2 pA = m_coordConverter->t2w( WVector3d_2( origin_t[0], origin_t[1], -50 ) );
            WVector3d_2 pO = m_coordConverter->t2w( WVector3d_2( origin_t[0], origin_t[1], 80 ) );
            ...
            for ( int i = -50; i <= 81; ++i )
            {
                WVector3d_2 tmpPoint = m_coordConverter->t2w( WVector3d_2( origin_t[0], origin_t[1], i ) );
                float rlength = 1.0;
                if ( i % 10 == 0 )
                {
                    rlength += 1.0;
                ...
                WVector3d_2 p1 = m_coordConverter->t2w( WVector3d_2( origin_t[0], origin_t[1] - rlength, i ) );
                WVector3d_2 p2 = m_coordConverter->t2w( WVector3d_2( origin_t[0], origin_t[1] + rlength, i ) );
...
osg::ref_ptr< osg::Geometry > WRulerOrtho::createZY()
{
    ...
    switch ( m_coordConverter->getCoordinateSystemMode() )
    {
        ...
        case CS_TALAIRACH:
        {
            ...
            for ( int i = -50; i <= 81; ++i )
            {
                WVector3d_2 tmpPoint = m_coordConverter->t2w( WVector3d_2( origin_t[0], 0, i ) );
                float rlength = 1.0;
                if ( i % 10 == 0 )
                {
                    rlength += 1.0;
                ...
                WVector3d_2 p1 = m_coordConverter->t2w( WVector3d_2( origin_t[0] - rlength, origin_t[1], i ) );
                WVector3d_2 p2 = m_coordConverter->t2w( WVector3d_2( origin_t[0] + rlength, origin_t[1], i ) );
