...
public:
    ...
    void setUp( void )
    {
        WVector3d_2 ac( 150, 122, 90 );
        WVector3d_2 pc( 110, 124, 97 );
        WVector3d_2 ihp( 140, 119, 188 );
        m_tc = boost::shared_ptr<WTalairachConverter> ( new WTalairachConverter( ac, pc, ihp ) );

        m_tc->setAp( WVector3d_2( 80, 0, 0 ) );
        m_tc->setPp( WVector3d_2( -97, 0, 0 ) );
        m_tc->setSp( WVector3d_2( 0, 0, 81 ) );
        m_tc->setIp( WVector3d_2( 0, 0, -41 ) );
        m_tc->setRp( WVector3d_2( 0, -60, 0 ) );
        m_tc->setLp( WVector3d_2( 0, 63, 0 ) );
    }
    ...
    {
        WVector3d_2 testPoint( 200, 60, 130 );
        WVector3d_2 result = m_tc->Canonical2ACPC( testPoint );
    ...
    {
        WVector3d_2 testPoint( 45.35, -57.6, 50.69 );
        WVector3d_2 result = m_tc->ACPC2Canonical( testPoint );
    ...
    {
        WVector3d_2 testPoint( 12, 43, -12 );
        WVector3d_2 result = m_tc->ACPC2Talairach( testPoint );
    ...
    {
        WVector3d_2 testPoint( 10.5, 46.41, -12.29 );
        WVector3d_2 result = m_tc->Talairach2ACPC( testPoint );
