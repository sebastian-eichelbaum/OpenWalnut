...
private:
    ...
    WPosition_2 m_posCenter; //!< stores the old position of the manipulator
    WPosition_2 m_posx1; //!< stores the old position of the manipulator
    WPosition_2 m_posx2; //!< stores the old position of the manipulator
    WPosition_2 m_posy1; //!< stores the old position of the manipulator
    WPosition_2 m_posy2; //!< stores the old position of the manipulator
    WPosition_2 m_posz1; //!< stores the old position of the manipulator
    WPosition_2 m_posz2; //!< stores the old position of the manipulator

    WPosition_2 m_posCenterOrig; //!< stores the old position of the manipulator
    WPosition_2 m_posx1Orig; //!< stores the old position of the manipulator
    WPosition_2 m_posx2Orig; //!< stores the old position of the manipulator
    WPosition_2 m_posy1Orig; //!< stores the old position of the manipulator
    WPosition_2 m_posy2Orig; //!< stores the old position of the manipulator
    WPosition_2 m_posz1Orig; //!< stores the old position of the manipulator
    WPosition_2 m_posz2Orig; //!< stores the old position of the manipulator
    ...
    WPosition_2 m_posRotCenter; //!< stores the old position of the manipulator
    WPosition_2 m_posRot; //!< stores the old position of the manipulator

    WPosition_2 m_posRotCenterOrig; //!< stores the old position of the manipulator
    WPosition_2 m_posRotOrig; //!< stores the old position of the manipulator
