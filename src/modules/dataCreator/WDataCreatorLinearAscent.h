...
#ifndef WDATACREATORLINEARASCENT_H
#define WDATACREATORLINEARASCENT_H
...
/**
 * Creates linear increasing values inside a given grid. This works for all kinds of datasets using WValueSetBase.
 */
class WDataCreatorLinearAscent: public WObjectNDIP< WDataSetSingleCreatorInterface >
{
public:
    /**
     * Default constructor.
...
#endif  // WDATACREATORLINEARASCENT_H
