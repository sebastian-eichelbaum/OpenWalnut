...
public:
     ...
     * \param numDeBoorPoints2 The number of de Boor points for the spline in the second direction.
     */
    void setDeBoorPoints( std::vector< WVector3d_2 > deBoorPoints, int numDeBoorPoints1, int numDeBoorPoints2 );
     ...
     */
    void samplePoints( std::vector< WVector3d_2 > *points, double tResolution, double uResolution );
...
private:
     ...
     */
    WVector3d_2 f( double t, double u );
    ...
    std::vector< WVector3d_2 > m_deBoorPoints; //!< The de Boor points of the splines.
