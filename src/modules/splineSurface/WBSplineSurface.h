...
public:
     ...
     * \param numDeBoorPoints2 The number of de Boor points for the spline in the second direction.
     */
    void setDeBoorPoints( std::vector< wmath::WVector3D > deBoorPoints, int numDeBoorPoints1, int numDeBoorPoints2 );
     ...
     */
    void samplePoints( std::vector< wmath::WVector3D > *points, double tResolution, double uResolution );
...
private:
    ...
    std::vector< wmath::WVector3D > m_deBoorPoints; //!< The de Boor points of the splines.
