...
public:
     ...
     * \return points
     */
    std::vector< WVector3d_2 > getSplinePoints();
     ...
     */
    void setSupportPoints( std::vector< WVector3d_2> supportPoints, bool forceUpdate = false );
...
private:
     ...
     * \return the matrix
     */
    WTensorSym< 2, 3, double > getCovarianceMatrix( std::vector< WVector3d_2 > points );
     ...
     */
    void getSplineSurfaceDeBoorPoints( std::vector< WVector3d_2 > &givenPoints, std::vector< WVector3d_2 > &deBoorPoints, int numRows, int numCols ); // NOLINT
    ...
    std::vector< WVector3d_2 > m_supportPoints; //!< stores the support points

    std::vector< WVector3d_2 > m_splinePoints; //!< stores the input points ????
