...
WBSpline::WBSpline( int order, std::vector< WVector3d_2 > deBoorPoints )
{
...
WBSpline::WBSpline( int order, std::vector< WVector3d_2 > deBoorPoints, std::vector<double> knots )
{
    m_order = order;
    m_deBoorPoints = deBoorPoints;
    m_knots = knots;
...
WVector3d_2 WBSpline::f( double _t )
{
    WVector3d_2 result;
    unsigned int r = 0, i;
...
std::vector< WVector3d_2 > WBSpline::getDeBoorPoints()
{
...
void WBSpline::setDeBoorPoints( std::vector< WVector3d_2 > deBoorPoints )
{
    m_deBoorPoints = deBoorPoints;
}
...
void WBSpline::samplePoints( std::vector< WVector3d_2 > *points, double resolution )
{
    ...
    for( int step = 0; step < steps; step++ )
    {
        ...
        WVector3d_2 samplePoint = f( currentT );
...
WVector3d_2 WBSpline::controlPoint_i_j( int _i, int _j )
{
    WVector3d_2 result;
