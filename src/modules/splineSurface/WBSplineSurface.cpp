...
WVector3d_2 WBSplineSurface::f( double _t, double _u )
{
    ...
    std::vector< WVector3d_2 > uSplineDeBoorPoints;

    for( int row = 0; row < m_numDeBoorPoints2; row++ )
    {
        std::vector< WVector3d_2 > tSplineDeBoorPoints;
        ...
        WVector3d_2 dmyArray = tSpline.f( _t );

        uSplineDeBoorPoints.push_back( WVector3d_2( dmyArray[0], dmyArray[1], dmyArray[2] ) );
    }
...
std::vector< WVector3d_2 > WBSplineSurface::getDeBoorPoints()
{
...
void WBSplineSurface::setDeBoorPoints( std::vector< WVector3d_2 > deBoorPoints, int numDeBoorPoints1, int numDeBoorPoints2 )
{
    m_deBoorPoints = deBoorPoints;
    m_numDeBoorPoints1 = numDeBoorPoints1;
    m_numDeBoorPoints2 = numDeBoorPoints2;
...
void WBSplineSurface::samplePoints( std::vector< WVector3d_2 > *points, double tResolution, double uResolution )
{
    ...
    for( stepU = 0; stepU < stepsU; stepU++ )
    {
        ...
        for( stepT = 0; stepT < stepsT; stepT++ )
        {
            ...
            WVector3d_2 samplePoint = f( currentT, currentU );
