...
#include "effecitveConnectivityCluster.xpm"
...
const std::string WMEffectiveConnectivityCluster::getName() const
{
    ...
    return "Effective Connectivity Cluster";
}
...
void WMEffectiveConnectivityCluster::properties()
{
    ...
    // 2: register your own handler: m_active->getCondition()->subscribeSignal( boost::bind( &WMEffectiveConnectivityCluster::myCustomActiveHandler, this ) );
...
void WMEffectiveConnectivityCluster::SafeUpdateCallback::operator()( osg::Node* node, osg::NodeVisitor* nv )
{
...
bool WMEffectiveConnectivityCluster::StringLength::accept( boost::shared_ptr< WPropertyVariable< WPVBaseTypes::PV_STRING > > /* property */,
