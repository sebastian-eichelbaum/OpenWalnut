...
private:
    /**
     * OSG Update Callback to change one child of a group node (add, change,
     * remove)
     * \note Only add it to a group node, and only as updateCallback!
     */
    class UpdateChildNodeCallback : public osg::NodeCallback
    {
    public:
        /**
         * Callback method called by the NodeVisitor when visiting a node.
         * Changes the group note according to the target child and the active
         * state.
         *
         * \param node The node this callback is connected to. Should be a group
         * node.
        ...
        /**
         * Choose to which node the child should be set.
         *
         * \param targetChild the requested child or NULL if the old child
         * should be removed
         */
        void setTargetChild( osg::ref_ptr< osg::Node > targetChild );

        /**
         * Set whether this NodeCallback should be connected to a group. Removes
         * it from its group if set to false.
         *
    ...
    private:
        /**
         * The node which is currently connected to the group node.
         */
        osg::ref_ptr <osg::Node> m_currentChild;

        /**
         * The node which should be connected to the group node.
         */
        osg::ref_ptr <osg::Node> m_targetChild;

        /**
         * Whether this NodeCallback should be active and connected to a group.
         */
        bool m_active;
    };
    ...
    /**
     * The NodeCallback which is connected to the scene of the widget.
     * Used to add or remove the scene graph which is generated by this module.
     */
    osg::ref_ptr< UpdateChildNodeCallback > m_updateChildNodeCallback;
