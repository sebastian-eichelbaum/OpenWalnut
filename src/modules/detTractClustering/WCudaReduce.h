...
/* this is based on code from projects/reduction/reduction_kernel.cu from CUDA SDK 2.0 */


#ifndef WMCUDAREDUCE_H
#define WMCUDAREDUCE_H

/* class to perform parallel reduction of elements in __shared__ memory,
 * the reduction operation is defined by Op::eval
 */
