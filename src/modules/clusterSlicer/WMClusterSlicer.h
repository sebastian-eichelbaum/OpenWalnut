...
protected:
     ...
     */
    WValue< double > meanParameter( boost::shared_ptr< std::set< WPosition_2 > > samplePoints ) const;
...
private:
     ...
     */
    bool isInBetween( const WPosition_2& vertex, const PlanePair& pp ) const;
     ...
     */
    std::vector< PlanePair > computeNeighbouringPlanePairs( const WPosition_2& vertex ) const;
     ...
     */
    PlanePair closestPlanePair( const std::vector< PlanePair >& pairs, const WPosition_2& vertex ) const;
     ...
     */
    WColor colorFromPlanePair( const WPosition_2& vertex, const PlanePair& pp ) const;
