...
#ifndef WMFIBERDISPLAY2_H
#define WMFIBERDISPLAY2_H
 ...
 */
class WMFiberDisplay2 : public WModule, public osg::Referenced
{
public:
    /**
...
private:
     ...
     */
    boost::shared_ptr< WModuleInputData< const WDataSetFibers2 > > m_fiberInput;

    /**
     * Pointer to the fiber data set
     */
    boost::shared_ptr< const WDataSetFibers2 > m_dataset;
    ...
    public: // NOLINT
        ...
        {
            osg::ref_ptr< WMFiberDisplay2 > module = static_cast< WMFiberDisplay2* > ( node->getUserData() );
...
inline const std::string WMFiberDisplay2::getName() const
{
    return std::string( "Fiber Display" );
}

inline const std::string WMFiberDisplay2::getDescription() const
{
    return std::string( "Draws fibers out of a WDataSetFibers" );
}

#endif  // WMFIBERDISPLAY2_H
