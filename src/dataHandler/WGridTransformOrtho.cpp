...
WGridTransformOrtho::WGridTransformOrtho( wmath::WMatrix< double > const& mat )
{
    WPrecond( mat.getNbRows() == 4 && mat.getNbCols() == 4, "" );
    m_directionX = wmath::WVector3D( mat( 0, 0 ), mat( 1, 0 ), mat( 2, 0 ) );
    m_directionY = wmath::WVector3D( mat( 0, 1 ), mat( 1, 1 ), mat( 2, 1 ) );
    m_directionZ = wmath::WVector3D( mat( 0, 2 ), mat( 1, 2 ), mat( 2, 2 ) );

    m_scaling = wmath::WVector3D( m_directionX.norm(), m_directionY.norm(), m_directionZ.norm() );
    ...
    m_origin = wmath::WVector3D( mat( 0, 3 ), mat( 1, 3 ), mat( 2, 3 ) );
}
...
wmath::WVector3D WGridTransformOrtho::positionToWorldSpace( wmath::WVector3D const& position ) const
{
    return wmath::WVector3D( m_scaling[ 0 ] * position[ 0 ] * m_directionX[ 0 ] + m_scaling[ 1 ] * position[ 1 ] * m_directionY[ 0 ]
...
wmath::WVector3D WGridTransformOrtho::positionToGridSpace( wmath::WVector3D const& position ) const
{
    wmath::WVector3D p = position - m_origin;
    p = wmath::WVector3D( p.dotProduct( m_directionX ), p.dotProduct( m_directionY ), p.dotProduct( m_directionZ ) );
    p[ 0 ] /= m_scaling[ 0 ];
    p[ 1 ] /= m_scaling[ 1 ];
    p[ 2 ] /= m_scaling[ 2 ];
    return p;
...
wmath::WVector3D WGridTransformOrtho::directionToWorldSpace( wmath::WVector3D const& direction ) const
{
    return wmath::WVector3D( m_scaling[ 0 ] * direction[ 0 ] * m_directionX[ 0 ] + m_scaling[ 1 ] * direction[ 1 ] * m_directionY[ 0 ]
...
wmath::WVector3D WGridTransformOrtho::directionToGridSpace( wmath::WVector3D const& direction ) const
{
    wmath::WVector3D p( direction.dotProduct( m_directionX ), direction.dotProduct( m_directionY ), direction.dotProduct( m_directionZ ) );
    p[ 0 ] /= m_scaling[ 0 ];
    p[ 1 ] /= m_scaling[ 1 ];
    p[ 2 ] /= m_scaling[ 2 ];
    return p;
...
wmath::WVector3D WGridTransformOrtho::getUnitDirectionX() const
{
    return m_directionX;
}

wmath::WVector3D WGridTransformOrtho::getUnitDirectionY() const
{
    return m_directionY;
}

wmath::WVector3D WGridTransformOrtho::getUnitDirectionZ() const
{
    return m_directionZ;
}

wmath::WVector3D WGridTransformOrtho::getDirectionX() const
{
    return m_directionX * m_scaling[ 0 ];
}

wmath::WVector3D WGridTransformOrtho::getDirectionY() const
{
    return m_directionY * m_scaling[ 1 ];
}

wmath::WVector3D WGridTransformOrtho::getDirectionZ() const
{
    return m_directionZ * m_scaling[ 2 ];
}

wmath::WPosition WGridTransformOrtho::getOrigin() const
{
    return m_origin;
}

wmath::WMatrix< double > WGridTransformOrtho::getTransformationMatrix() const
{
