...
public:
    ...
    WDataSetRawHARDI( boost::shared_ptr< WValueSetBase > newValueSet,
                      ...
                      boost::shared_ptr< std::vector< WVector3d_2 > > newGradients,
     ...
     * \param index
     */
    const WVector3d_2& getGradient( size_t index ) const;
     ...
     */
    std::vector< WVector3d_2 > const& getOrientations() const;
...
private:
    boost::shared_ptr< std::vector< WVector3d_2 > > m_gradients; //!< Gradients of measurements
    /**
