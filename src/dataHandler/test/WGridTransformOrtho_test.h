...
public:
    ...
    {
        {
            ...
            TS_ASSERT_EQUALS( v.getUnitDirectionX(), WVector3d_2( 1.0, 0.0, 0.0 ) );
            TS_ASSERT_EQUALS( v.getUnitDirectionY(), WVector3d_2( 0.0, 1.0, 0.0 ) );
            TS_ASSERT_EQUALS( v.getUnitDirectionZ(), WVector3d_2( 0.0, 0.0, 1.0 ) );
            TS_ASSERT_EQUALS( v.getDirectionX(), WVector3d_2( 1.0, 0.0, 0.0 ) );
            TS_ASSERT_EQUALS( v.getDirectionY(), WVector3d_2( 0.0, 1.0, 0.0 ) );
            TS_ASSERT_EQUALS( v.getDirectionZ(), WVector3d_2( 0.0, 0.0, 1.0 ) );
            TS_ASSERT_EQUALS( v.getOrigin(), WVector3d_2( 0.0, 0.0, 0.0 ) );
        }
        {
        ...
        }
        {
            ...
            TS_ASSERT_EQUALS( v.getUnitDirectionY(), WVector3d_2( 0.0, 1.0, 0.0 ) );
            TS_ASSERT_EQUALS( v.getUnitDirectionZ(), WVector3d_2( 0.0, 0.0, -1.0 ) );
            TS_ASSERT_EQUALS( v.getDirectionX(), WVector3d_2( 2.2, 0.0, 0.0 ) );
            TS_ASSERT_EQUALS( v.getDirectionY(), WVector3d_2( 0.0, 3.3, 0.0 ) );
            TS_ASSERT_EQUALS( v.getDirectionZ(), WVector3d_2( 0.0, 0.0, -1.0 ) );
            TS_ASSERT_EQUALS( v.getOrigin(), WVector3d_2( 0.0, 0.0, 0.0 ) );
        }
        {
        ...
        }
        {
            ...
            TS_ASSERT_EQUALS( v.getDirectionZ(), WVector3d_2( 0.0, 0.0, 4.4 ) );
            TS_ASSERT_EQUALS( v.getOrigin(), WVector3d_2( 1.0, 2.0, 0.5 ) );
        }
    }
    ...
    {
        {
            ...
            WVector3d_2 v( -7.64, 8.73, -0.0063 );
...

        {
            ...
            WVector3d_2 v( 1.0, 1.0, 1.0 );

            TS_ASSERT_EQUALS( WVector3d_2( 2.2, 3.3, 4.4 ), t.positionToWorldSpace( v ) );
            TS_ASSERT_EQUALS( WVector3d_2( 2.2, 3.3, 4.4 ), t.directionToWorldSpace( v ) );
        }

        {
            ...
            TS_ASSERT_EQUALS( WVector3d_2( 3.2, 5.3, 4.9 ), t.positionToWorldSpace( v ) );
            TS_ASSERT_EQUALS( WVector3d_2( 2.2, 3.3, 4.4 ), t.directionToWorldSpace( v ) );
        }
        {
            WMatrix< double > mat( 4, 4 );
            ...
            WVector3d_2 w = t.positionToWorldSpace( v );
            TS_ASSERT_DELTA( 0.0, w[ 0 ], 0.0001 );
            TS_ASSERT_DELTA( 7.0, w[ 1 ], 0.0001 );
            TS_ASSERT_DELTA( 4.9, w[ 2 ], 0.0001 );
            TS_ASSERT_EQUALS( WVector3d_2( -1.0, 5.0, 4.4 ), t.directionToWorldSpace( v ) );
        }
    }
    ...
    void testTransformationToGridSpace()
    {
        ...
        {
            WGridTransformOrtho t( 2.2, 3.3, 4.4 );
            WVector3d_2 v( 2.2, 3.3, 4.4 );

            TS_ASSERT_EQUALS( WVector3d_2( 1.0, 1.0, 1.0 ), t.positionToGridSpace( v ) );
            TS_ASSERT_EQUALS( WVector3d_2( 1.0, 1.0, 1.0 ), t.directionToGridSpace( v ) );
        }

        {
            ...
            TS_ASSERT_EQUALS( WVector3d_2( 1.0, 1.0, 1.0 ), t.positionToGridSpace( WVector3d_2( 3.2, 5.3, 4.9 ) ) );
            TS_ASSERT_EQUALS( WVector3d_2( 1.0, 1.0, 1.0 ), t.directionToGridSpace( WVector3d_2( 2.2, 3.3, 4.4 ) ) );
        }
        {
            WMatrix< double > mat( 4, 4 );
            mat.makeIdentity();
