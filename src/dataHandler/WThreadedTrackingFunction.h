...
#define TRACKING_EPS 0.0000001
    ...
    public:
        ...
        typedef std::pair< WVector3d_2, WVector3d_2 > JobType;
        ...
        typedef boost::function< WVector3d_2 ( DataSetPtr, JobType const& ) > DirFunc;
         ...
         */
        static bool onBoundary( Grid3DPtr grid, WVector3d_2 const& pos );
         ...
         */
        static double getDistanceToBoundary( Grid3DPtr grid, WVector3d_2 const& pos, WVector3d_2 const& dir );
    };
    ...
    typedef boost::function< void ( std::vector< WVector3d_2 > const& ) > FiberVisitorFunc;

    //! a visitor function type for points
    typedef boost::function< void ( WVector3d_2 const& ) > PointVisitorFunc;
