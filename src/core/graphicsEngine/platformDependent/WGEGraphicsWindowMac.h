...
#ifndef WGEGRAPHICSWINDOWMAC_H
#define WGEGRAPHICSWINDOWMAC_H
...
public:
     ...
     * \exception WGEInitFailed thrown if initialization of graphics context or graphics WindowMac has failed.
     */
    WGEGraphicsWindowMac( int x, int y, int width, int height );

    /**
     * Destructor.
     */
    virtual ~WGEGraphicsWindowMac();
...
protected:
    ...
    /**
     * OpenSceneGraph render WindowMac.
     */
    osg::ref_ptr<osgViewer::GraphicsWindow> m_GraphicsWindow;
private:
};

#endif  // WGEGRAPHICSWINDOWMAC_H
